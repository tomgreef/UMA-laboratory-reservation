...
class BranchAndBoundAlgorithmTest {
    ...
    @Autowired
    private BranchAndBoundAlgorithmService service;
    @Autowired
    ...
    void reservationGetsMostlyLaboratoryPreference() {
        ...
        reservationService.saveExcel(reservations, semester);
        laboratories.forEach(laboratoryDto -> laboratoryService.upsert(laboratoryDto));
        geneticAlgorithmService.runAlgorithm(semester);
        AssignmentDto assignation = reservationAssignmentService.findAssignationBySemester(semester.getId());
    ...
    void algorithmOptimizesInitialPopulation() {
        ...
        Solution solutionWithNoPenaltyScore = geneticAlgorithmService.createRandomSolution(reservations, laboratoryService.findAll());
        solutionWithNoPenaltyScore.setPenalties(geneticAlgorithmService.getPenaltyOccurrences(solutionWithNoPenaltyScore));
        ...
        EnumMap<PenaltyType, Integer> penaltyOccurrences = geneticAlgorithmService.getPenaltyOccurrences(solution);
